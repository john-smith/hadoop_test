...
public class Recommender3_2 {
    public static void main(String[] args) throws Exception {
        ...
        IRStatistics stats = evaluator.evaluate(builder, modelBuilder, model, null, 10, GenericRecommenderIRStatsEvaluator.CHOOSE_THRESHOLD, 1.0);
